...
static const ERR_STRING_DATA CMS_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_AUTHENVELOPEDDATA_CREATE, 0),
     "CMS_AuthEnvelopedData_create"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_AUTHENVELOPEDDATA_FINAL, 0),
     "cms_AuthEnvelopedData_final"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_AUTHENVELOPEDDATA_INIT_BIO, 0),
     "cms_AuthEnvelopedData_init_bio"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_AUTH_ENVELOPED_DATA_INIT, 0),
    ...
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_GET0_AUTH_ENVELOPED, 0),
     "cms_get0_auth_enveloped"},
    ...
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_GET_ENVELOPED_TYPE, 0),
